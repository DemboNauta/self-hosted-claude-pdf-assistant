...
export const es = {
  ...
  voice: {
    start: 'Modo voz: hablar con Claude',
    stop: 'Salir del modo voz',
    pause: 'Pausar',
    resume: 'Seguir',
    phases: {
      off: '',
      ...
      paused: 'En pausa · di «sigue» o pregunta',
    },
    ...
    error: 'El micrófono ha fallado; sigo intentándolo.',
    sample:
      'Hola, soy Claude. Cuando actives el modo voz te explicaré el documento con ejemplos, y podrás interrumpirme cuando quieras.',
    settings: {
      title: 'Voz de Claude',
